...
# cake build
# ```
task 'build', 'compile source', -> build -> log "Compiled with no errors", green
...
# cake watch
# ```
task 'watch', 'compile and watch', -> build true, -> log "Compiled with now errors. Watching..", green
...
# cake test
# ```
task 'test', 'run tests', -> build -> mocha -> log "Running tests.", green
...
# cake clean
# ```
task 'clean', 'clean generated files', -> clean -> log "Cleaned generated files.", green
